...
parser.add_argument('--wgan',               type=int,   default=0,          help='Choose to train with wgan 1 or vanilla-gan 0')
parser.add_argument('--disc_updates',       type=int,   default=5,          help='Number of critic updates')
parser.add_argument('--post_proc',          type=int,   default=1,          help='Choose to apply post processing to generated samples 1, 0 otherwise')
parser.add_argument('--phase_shift',        type=int,   default=2,          help='Choose the phase shuffle shift param')
parser.add_argument('--attention',          type=int,   default=0,          help='Choose to add attention 1 or not 0')
parser.add_argument('--extended_seq',       type=int,   default=0,          help='Choose the seq_len 16384 setting to 0 or 65536 via 1')
